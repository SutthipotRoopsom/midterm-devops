...
// Mock data to replace placeholders
const gitSteps = [
  { title: 'Clone', detail: 'Clone the repository to local machine' },
  { title: 'Branch', detail: 'Create a feature branch' },
  { title: 'Commit', detail: 'Commit changes with clear messages' },
  { title: 'Push', detail: 'Push branch to remote' }
];
const dockerItems = [
  { title: 'Container', detail: 'Isolated execution environment' },
  { title: 'Image', detail: 'Read-only template for creating containers' },
